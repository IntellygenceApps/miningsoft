<div class="">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Bandeja de Entrada <small> Inbox</small></h2>
              ...
              <div class="col-sm-3 mail_list_column">
                ...
                <a href="#">
                  <div class="mail_list">
                    ...
                    <div class="right">
                      <h3><?php echo clean($a->from); ?> <small><?php echo $a->date; ?></small></h3>
                      <p><?php echo clean($a->subject); ?></p>
                    </div>
                  </div>
                </a>
