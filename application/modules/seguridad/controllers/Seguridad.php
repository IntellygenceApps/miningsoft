...
class Seguridad extends CI_Controller {
	...
	public function user()
	{
		try{
			...
			$crud->set_relation_n_n('Sucursales', 'ms_ms_ususucursal', 'ms_me_sucursal', 'UsuarioId', 'SucursalId', 'Nombre');
			$crud->set_field_upload('Foto','assets/uploads/profiles');	
			$crud->set_field_upload('Firma','assets/uploads/profiles/signature');			
	...
	public function optiontype()
	{
		try{
			$crud = new grocery_CRUD();			
			$crud->set_table('ms_ms_tipoopc');
			$crud->set_subject('Tipo de Opcion');
			$crud->required_fields('Nombre', 'Simbolo','Status');		
	...
	public function typethird()
	{
		try{
			...
			$crud->set_relation_n_n('Procesos', 'ms_mp_terceproc', 'ms_mp_proceso', 'TipoTerceroId', 'ProcesoId', 'Nombre','Orden');
			$crud->required_fields('Nombre','Sigla','Status');
			$crud->unset_delete();
